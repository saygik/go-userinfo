...
func (a *App) StartHTTPServer() error {
	...
	api.NewHandler(s.Rtr, a.c.GetUseCase(), a.log, a.c.GetAuth(a.cfg.Jwt.AccessSecret, a.cfg.Jwt.RefreshSecret, a.cfg.Jwt.AtExpires, a.cfg.Jwt.RtExpires), a.c.GetHydra())
